        ...
        <div className="container-despesa-cad">
            <div className="box-despesa-cad">
                ...
                <div className="input-group">
                    <p>Valor</p>
                    <input type="text" className="input-lg w-100" id="valor" value={valor} onChange={(e) => setValor(e.target.value)} />
                </div>

                <div className="input-group">
                    <p>Descrição</p>
                    <input type="text" className="w-100" id="valor" value={descricao} onChange={(e) => setDescricao(e.target.value)} />
                </div>
